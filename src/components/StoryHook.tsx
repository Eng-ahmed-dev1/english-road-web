      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
          <div className="flex items-center gap-2.5">
            <span className={`inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs sm:text-sm font-black text-white bg-gradient-to-r ${hook.gradient} shadow-sm animate-pulse`}>
          ...
          <div className="flex items-center gap-1.5 text-xs sm:text-sm font-bold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 px-3 py-1 rounded-xl">
        ...
        <div className="my-5 space-y-3">
          <div className="flex items-start gap-3">
            <div className="p-2.5 rounded-2xl bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 shrink-0 mt-1 shadow-xs border border-blue-100 dark:border-blue-800/50">
              <Lightbulb className="w-6 h-6 animate-bounce" style={{ animationDuration: '2.5s' }} />
            </div>
            <div>
              <span className="text-xs font-black uppercase tracking-wider text-blue-600 dark:text-blue-400 block mb-1">
                The Core Warm-Up Hook • خطاف التمهيد والتفكير
              </span>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-slate-900 dark:text-white font-en leading-snug tracking-tight">
                "{hook.hookQuestionEn}"
              </h2>
            </div>
          </div>
          ...
          <div className="pr-12">
            <p className="text-base sm:text-lg lg:text-xl font-bold text-slate-700 dark:text-slate-300 font-ar leading-relaxed bg-slate-50 dark:bg-slate-800/60 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
              💡 {hook.hookQuestionAr}
            </p>
          </div>
        </div>
